    ...
    mutations: {
        ...
        [SNACK_ERROR_LIST]: (state, { expression, error }) => {
            ...
            if (error.response && error.response.data && error.response.data.errors) {
                ...
                state.message = `Hay un error${expression} => ${error.response.status}: ` + (error.response.data && error.response.data.message && error.response.data.message.Message ? error.response.data.message.Message : error.response.statusText)
            }
            state.show = true
        }
    },
